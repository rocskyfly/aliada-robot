...
def show_image(file_path):
    ...
    if sys.platform == "darwin":
        ...
        webbrowser.open(os.path.join(aliadapath.TEMP_PATH, file_path))
...
class WXBot:
    ...
    def __init__(self):
        ...
        # 文件缓存目录
        self.temp_pwd = aliadapath.TEMP_PATH
        # 登录图片所在目录
        self.login_pwd = aliadapath.LOGIN_PATH
    ...
    def run(self, Mic=None):
        self.get_uuid()
        self.gen_qr_code(os.path.join(aliadapath.DATA_PATH, 'wxqr.png'))
